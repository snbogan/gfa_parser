...
def main():
    ...
    parser.add_argument('-p', '--package', choices=['hifiasm', 'verkko', 'shasta', 'minigraph'], default='hifiasm', help='Which assembler package to run')
    ...
    if args.package in ['shasta', 'minigraph']:
        ...
        cmd = ['python3', script_to_run] + sys.argv[1:]
        # Remove -p/--package from args to avoid recursion
        new_cmd = []
        skip_next = False
    ...
    # Original script for hifiasm or verkko
    try:
